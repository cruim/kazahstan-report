...
$gridColumns = [
    [
        'value' => function ($data){
            if($data['order_delivery_data_name'] == 'Казахстан Курьеры')
                return 'Казахстан Курьеры отправлен';
            else
    ...
    [
        'value' => '4-5 days',
        'header' => 'от 4 до 5 дней'
    ],

    [
        'value' => '6+ days',
        'header' => '6 дней и более'
    ],
